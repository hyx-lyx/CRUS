...
if __name__ == '__main__':
    ...
    for image_idx in tqdm(range(len(np_files_path))):
        ...
        if not args.rerun:
            ...
            from helper_generate_GC_GNN import generate_gcn
                ...
                while True:
                    try:
                        proc = subprocess.Popen([
                            'python3', folder + '/helper_generate_GC_GNN.py',
                        ...
                        proc.kill()
                        # This is determined by the sys.stdout in `helper_generate_GNN.py`
    ...
    print('All GC+GNN results generated.')
    print('Dice: %.3f \u00B1 %.3f.' %
